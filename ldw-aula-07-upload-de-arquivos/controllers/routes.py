...
import urllib
import json
import uuid # biblioteca que cria um identificador único para algo (nesse caso, os arquivos)
import os  
...
def init_app(app):
    ...
    def galeria():
        ...
        if request.method == 'POST':
            # captura o arquivo vindo formulário
            ...
            if not arquivos_permitidos(file.filename):
                ...
                flash('Utilize somente tipos de arquivos de imagens png, jpg, jpeg e gif.', 'danger')
